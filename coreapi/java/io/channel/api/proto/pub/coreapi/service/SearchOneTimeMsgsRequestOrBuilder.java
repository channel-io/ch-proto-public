...
public interface SearchOneTimeMsgsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:coreapi.service.SearchOneTimeMsgsRequest)
   ...
   */
  java.util.List<io.channel.api.proto.pub.coreapi.model.OneTimeMsgState> getStatesList();
  /**
   * <pre>
   * Filter by one-time message lifecycle states.
   * If empty, all states are included.
   ...
   */
  io.channel.api.proto.pub.coreapi.model.OneTimeMsgState getStates(int index);
  /**
   * <pre>
   * Filter by one-time message lifecycle states.
   * If empty, all states are included.
