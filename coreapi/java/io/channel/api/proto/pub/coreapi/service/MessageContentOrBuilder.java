...
public interface MessageContentOrBuilder extends
    // @@protoc_insertion_point(interface_extends:coreapi.service.MessageContent)
   ...
   */
  java.util.List<io.channel.api.proto.pub.coreapi.service.MessageOption> getOptionsList();
  /**
   * <pre>
   * Option flags that modify message delivery and display behavior.
   * +kubebuilder:validation:Nullable
   ...
   */
  io.channel.api.proto.pub.coreapi.service.MessageOption getOptions(int index);
  /**
   * <pre>
   * Option flags that modify message delivery and display behavior.
   * +kubebuilder:validation:Nullable
